...
```{r}
# create comparison vectors (everything is binary)
...
\footnotesize
```{r}
# inspect 1st five rows of the comparison vectors
rpairs$pairs[1:5,]
```
...
```{r}
# blocking and comparison vectors
rpairs <- compare.dedup(RLdata10000, 
                        blockfld = list(1,5:7),
...
Find the the precision, recall, and f-measure (with and without blocking). 
...
<!-- library(ff) -->
<!-- library(ffbase) # https://github.com/edwindj/ffbase -->
