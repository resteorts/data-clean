...
\multirow{2}{*}{N= Total Records}
    & \multicolumn{3}{c|}{Actual Linkage}    \\
    \cline{2-4}
    &   & No & Yes                      \\
  \hline
\multirow{2}{*}{Predicted Linkage}
...
\begin{itemize}
\item ``True”/“False" = prediction is correct/incorrect
...
\item Specificity = Precision = 1 - FPR = $\dfrac{TP}{TP + FP}$
\end{itemize}
