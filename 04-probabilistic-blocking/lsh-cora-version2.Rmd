...
head(minhashes(corpus[[1]])) # verify we have minhashes in our corpus
length(minhashes(corpus[[1]])) # our dataset is now represented by n=360 randomly selected and hashed shingles
# this is equivalent (mathematically) to finding the Jaccard similarity of all-to-all record comparisons.
lsh_threshold(h=360, b=90)
lsh_probability(h=360,b=90,s=0.4)
```
...
#potential_matches_record1 <- lsh_query(buckets, "1")
#potential_matches_record1
...
TODO: Show the plot below, calculate precision and recall for these comparisons. 
Note: This only really does dimension reduction for comparisons of records and provides overlapping blocks. 
