...
\institute{\normalsize Associate Professor, Department of Statistical Science, affiliated faculty in Computer Science, Biostatistics and Bioinformatics, the information initiative at Duke (iiD) and \\the Social Science Research Institute (SSRI) \\ Duke University and U.S. Census Bureau\\ \vspace*{1em}

This work is partially supported by NSF CAREER Award 1652431. The views are of the author and not any agency, etc.
...
\begin{enumerate}
\item One common type of blocking is using q-grams [Christen, 2012b, Papadakis et al., 2015].
